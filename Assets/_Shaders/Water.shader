...
Shader "SynLogic/Water v2"
{
	...
	SubShader
	{
		...
		{
			float temp_output_13_0_g66 = ( ( 2.0 * UNITY_PI ) / _WaveAmplitude );
			float Wavelength18_g66 = temp_output_13_0_g66;
			float temp_output_47_0_g66 = _WaveHeight;
			float temp_output_20_0_g66 = ( temp_output_47_0_g66 * 2.0 );
			float temp_output_37_0_g66 = ( ( _WaveSteepness / ( ( Wavelength18_g66 * temp_output_20_0_g66 ) * ( 1.0 * ( 2.0 * UNITY_PI ) ) ) ) * temp_output_47_0_g66 );
			float4 temp_output_52_0_g66 = _WaveDirection4;
			float4 normalizeResult8_g66 = normalize( temp_output_52_0_g66 );
			float3 ase_worldPos = mul( unity_ObjectToWorld, v.vertex );
			float4 transform5_g66 = mul(unity_WorldToObject,float4( ase_worldPos , 0.0 ));
			float dotResult17_g66 = dot( normalizeResult8_g66 , float4( (transform5_g66).xyz , 0.0 ) );
			float temp_output_26_0_g66 = ( ( dotResult17_g66 * temp_output_13_0_g66 ) + ( ( temp_output_13_0_g66 * _WaveSpeed ) * _Time.y ) );
			float temp_output_31_0_g66 = cos( temp_output_26_0_g66 );
			float4 appendResult44_g66 = (float4(( temp_output_37_0_g66 * ( (temp_output_52_0_g66).r * temp_output_31_0_g66 ) ) , ( temp_output_37_0_g66 * ( (temp_output_52_0_g66).g * temp_output_31_0_g66 ) ) , ( temp_output_20_0_g66 * sin( temp_output_26_0_g66 ) ) , 0.0));
			float temp_output_13_0_g64 = ( ( 2.0 * UNITY_PI ) / _WaveAmplitude );
			float Wavelength18_g64 = temp_output_13_0_g64;
			float temp_output_47_0_g64 = _WaveHeight;
			float temp_output_20_0_g64 = ( temp_output_47_0_g64 * 2.0 );
			float temp_output_37_0_g64 = ( ( _WaveSteepness / ( ( Wavelength18_g64 * temp_output_20_0_g64 ) * ( 1.0 * ( 2.0 * UNITY_PI ) ) ) ) * temp_output_47_0_g64 );
			float4 temp_output_52_0_g64 = _WaveDirection1;
			float4 normalizeResult8_g64 = normalize( temp_output_52_0_g64 );
			float4 transform5_g64 = mul(unity_WorldToObject,float4( ase_worldPos , 0.0 ));
			float dotResult17_g64 = dot( normalizeResult8_g64 , float4( (transform5_g64).xyz , 0.0 ) );
			float temp_output_26_0_g64 = ( ( dotResult17_g64 * temp_output_13_0_g64 ) + ( ( temp_output_13_0_g64 * _WaveSpeed ) * _Time.y ) );
			float temp_output_31_0_g64 = cos( temp_output_26_0_g64 );
			float4 appendResult44_g64 = (float4(( temp_output_37_0_g64 * ( (temp_output_52_0_g64).r * temp_output_31_0_g64 ) ) , ( temp_output_37_0_g64 * ( (temp_output_52_0_g64).g * temp_output_31_0_g64 ) ) , ( temp_output_20_0_g64 * sin( temp_output_26_0_g64 ) ) , 0.0));
			float temp_output_13_0_g63 = ( ( 2.0 * UNITY_PI ) / _WaveAmplitude );
			float Wavelength18_g63 = temp_output_13_0_g63;
			float temp_output_47_0_g63 = _WaveHeight;
			float temp_output_20_0_g63 = ( temp_output_47_0_g63 * 2.0 );
			float temp_output_37_0_g63 = ( ( _WaveSteepness / ( ( Wavelength18_g63 * temp_output_20_0_g63 ) * ( 1.0 * ( 2.0 * UNITY_PI ) ) ) ) * temp_output_47_0_g63 );
			float4 temp_output_52_0_g63 = _WaveDirection2;
			float4 normalizeResult8_g63 = normalize( temp_output_52_0_g63 );
			float4 transform5_g63 = mul(unity_WorldToObject,float4( ase_worldPos , 0.0 ));
			float dotResult17_g63 = dot( normalizeResult8_g63 , float4( (transform5_g63).xyz , 0.0 ) );
			float temp_output_26_0_g63 = ( ( dotResult17_g63 * temp_output_13_0_g63 ) + ( ( temp_output_13_0_g63 * _WaveSpeed ) * _Time.y ) );
			float temp_output_31_0_g63 = cos( temp_output_26_0_g63 );
			float4 appendResult44_g63 = (float4(( temp_output_37_0_g63 * ( (temp_output_52_0_g63).r * temp_output_31_0_g63 ) ) , ( temp_output_37_0_g63 * ( (temp_output_52_0_g63).g * temp_output_31_0_g63 ) ) , ( temp_output_20_0_g63 * sin( temp_output_26_0_g63 ) ) , 0.0));
			float4 temp_output_863_0 = appendResult44_g63;
			float temp_output_13_0_g65 = ( ( 2.0 * UNITY_PI ) / _WaveAmplitude );
			float Wavelength18_g65 = temp_output_13_0_g65;
			float temp_output_47_0_g65 = _WaveHeight;
			float temp_output_20_0_g65 = ( temp_output_47_0_g65 * 2.0 );
			float temp_output_37_0_g65 = ( ( _WaveSteepness / ( ( Wavelength18_g65 * temp_output_20_0_g65 ) * ( 1.0 * ( 2.0 * UNITY_PI ) ) ) ) * temp_output_47_0_g65 );
			float4 temp_output_52_0_g65 = _WaveDirection3;
			float4 normalizeResult8_g65 = normalize( temp_output_52_0_g65 );
			float4 transform5_g65 = mul(unity_WorldToObject,float4( ase_worldPos , 0.0 ));
			float dotResult17_g65 = dot( normalizeResult8_g65 , float4( (transform5_g65).xyz , 0.0 ) );
			float temp_output_26_0_g65 = ( ( dotResult17_g65 * temp_output_13_0_g65 ) + ( ( temp_output_13_0_g65 * _WaveSpeed ) * _Time.y ) );
			float temp_output_31_0_g65 = cos( temp_output_26_0_g65 );
			float4 appendResult44_g65 = (float4(( temp_output_37_0_g65 * ( (temp_output_52_0_g65).r * temp_output_31_0_g65 ) ) , ( temp_output_37_0_g65 * ( (temp_output_52_0_g65).g * temp_output_31_0_g65 ) ) , ( temp_output_20_0_g65 * sin( temp_output_26_0_g65 ) ) , 0.0));
			float4 temp_output_861_0 = appendResult44_g65;
			float4 break824 = ( ( appendResult44_g66 + appendResult44_g64 + temp_output_863_0 + temp_output_861_0 ) + ( temp_output_863_0 + temp_output_861_0 ) );
			float4 appendResult825 = (float4(break824.y , ( break824.x + break824.z ) , break824.x , 0.0));
			float4 VertexOffset800 = appendResult825;
			v.vertex.xyz += lerp(float4( 0,0,0,0 ),VertexOffset800,_VertexOffset).xyz;
		}
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float2 uv_TexCoord248 = i.uv_texcoord * _Normals_ST.xy + _Normals_ST.zw;
			float2 panner247 = ( _Time.y * _NormalSpeed + uv_TexCoord248);
			float2 appendResult368 = (float2((panner247).x , ( (panner247).y + 1.0 )));
...
/*ASEBEGIN
Version=15800
294;708;1517;696;3122.74;-1043.11;3.153705;True;False
Node;AmplifyShaderEditor.CommentaryNode;325;-1416.183,-563.6989;Float;False;2340.537;498.5604;;20;278;431;1116;432;833;1118;368;1117;365;561;369;366;367;1115;247;248;251;250;1170;843;Normals;1,1,1,1;0;0
Node;AmplifyShaderEditor.TextureTransformNode;843;-1372.958,-472.6601;Float;False;833;1;0;SAMPLER2D;sampler0843;False;2;FLOAT2;0;FLOAT2;1
Node;AmplifyShaderEditor.TextureCoordinatesNode;248;-1104.876,-485.8674;Float;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleTimeNode;250;-1080.166,-220.8936;Float;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;251;-1085.112,-357.4818;Float;False;Property;_NormalSpeed;Normal Speed;11;0;Create;True;0;0;False;0;0,0.05;-0.001,-0.002;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.PannerNode;247;-807.6365,-389.7703;Float;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;432;128.1613,-146.4667;Float;False;Property;_NormalStrength;Normal Strength;13;0;Create;True;0;0;False;0;0.5;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;1107;-1356.861,447.8899;Float;False;Property;_FakeLightVector;Fake Light Vector;29;0;Create;True;0;0;False;0;0,0,0;-1.02,0.79,1.23;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.ColorNode;792;-1043.912,1005.659;Float;False;Property;_WaveDirection4;Wave Direction 4;27;0;Create;True;0;0;False;0;0.8602941,0,0,0;0.9448276,0,1,0;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ToggleSwitchNode;1106;-1030.596,339.7957;Float;False;Property;_FakeLightDir;Fake Light Dir;28;0;Create;True;0;0;False;0;0;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;781;-1043.961,1181.914;Float;False;Property;_WaveHeight;Wave Height;21;0;Create;True;0;0;False;0;11;0.05;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;784;-1096.125,1502.865;Float;False;Property;_WaveSteepness;Wave Steepness;23;0;Create;True;0;0;False;0;1;7.18;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;794;-1082.935,1919.245;Float;False;Property;_WaveDirection3;Wave Direction 3;26;0;Create;True;0;0;False;0;0,0.9172413,1,0;0,0.2137927,1,0;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;795;-1065.104,1429.946;Float;False;Property;_WaveSpeed;Wave Speed;22;0;Create;True;0;0;False;0;1;0.02;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;801;-1091.228,1746.102;Float;False;Property;_WaveDirection2;Wave Direction 2;25;0;Create;True;0;0;False;0;1,0.5586207,0,0;0,1,0.04827526,0;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;793;-1101.895,1574.829;Float;False;Property;_WaveDirection1;Wave Direction 1;24;0;Create;True;0;0;False;0;0.6352941,1,0,0;1,0,0,0;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;1083;-861.8157,-1188.128;Float;False;278;Normals;1;0;OBJECT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;782;-1048.863,1273.802;Float;False;Property;_WaveAmplitude;Wave Amplitude;20;0;Create;True;0;0;False;0;1;0.18;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;861;-614.7366,1752.611;Float;False;WaterWave;-1;;65;33ce65a09b35d3e4b9904c4149eac367;0;6;47;FLOAT;0;False;56;FLOAT;0;False;51;FLOAT;0;False;50;FLOAT;0;False;52;COLOR;0,0,0,0;False;57;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.FunctionNode;860;-621.8616,1353.914;Float;False;WaterWave;-1;;64;33ce65a09b35d3e4b9904c4149eac367;0;6;47;FLOAT;0;False;56;FLOAT;0;False;51;FLOAT;0;False;50;FLOAT;0;False;52;COLOR;0,0,0,0;False;57;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.FunctionNode;863;-619.8616,1550.914;Float;False;WaterWave;-1;;63;33ce65a09b35d3e4b9904c4149eac367;0;6;47;FLOAT;0;False;56;FLOAT;0;False;51;FLOAT;0;False;50;FLOAT;0;False;52;COLOR;0,0,0,0;False;57;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.GetLocalVarNode;1133;-1331.109,123.1146;Float;False;1170;NormalMap;1;0;OBJECT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;862;-619.0605,1149.842;Float;False;WaterWave;-1;;66;33ce65a09b35d3e4b9904c4149eac367;0;6;47;FLOAT;0;False;56;FLOAT;0;False;51;FLOAT;0;False;50;FLOAT;0;False;52;COLOR;0,0,0,0;False;57;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.RangedFloatNode;342;976.9902,-388.3336;Float;False;Property;_MinTesDistance;Min Tes Distance;18;0;Create;True;0;0;False;0;0;76;0;300;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;344;976.2053,-461.2697;Float;False;Property;_TesselationFactor;Tesselation Factor;16;0;Create;True;0;0;False;0;32;32;1;32;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;343;979.0153,-310.504;Float;False;Property;_MaxTesDistance;Max Tes Distance;17;0;Create;True;0;0;False;0;5;134;0;300;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;722;1077.275,-574.4399;Float;False;800;VertexOffset;1;0;OBJECT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.DistanceBasedTessNode;341;1271.118,-420.1682;Float;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;1173;1301.323,-597.3116;Float;False;Property;_VertexOffset;Vertex Offset;19;0;Create;True;0;0;False;0;1;2;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.GetLocalVarNode;887;1298.773,-499.9211;Float;False;886;VertexNormals;1;0;OBJECT;0;False;1;FLOAT3;0
...
WireConnection;0;11;1173;0
WireConnection;0;14;341;0
ASEEND*/
//CHKSM=2DAA3FB8BE5688F13E687DFF0A8DD6B8949C5C10